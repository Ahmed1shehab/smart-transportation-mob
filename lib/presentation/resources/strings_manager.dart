...
//onBoarding
  ...
  static const String onBoardingTitle2 = "AI-Driven Routes for Efficiency";

  static const String onBoardingTitle3 = "Real-Time Tracking and Safety";
  static const String onBoardingSubTitle1 =
      "Join us in revolutionizing school transportation. Our app ensures safe, efficient commutes for students.";
  static const String onBoardingSubTitle2 =
      "Our technology optimizes routes, saving time and resources for schools and families.";
  static const String onBoardingSubTitle3 =
      "Get instant updates, track buses live, and feel secure knowing student safety is our priority.";
  ...
  static const String dataFieldFail = "Data field is missing in response";

  static const String welcome = "Welcome Dear!";
  static const String pleaseProvideDetails =
      "Please provide the following details to complete your organizer account";
  ...
  static const String termsAndConditionsText = '1. Introduction\n'
      'Welcome to Sonic! By signing up and using our services, you agree to comply with these Terms and Conditions. Please read them carefully before proceeding.\n\n'
      '2. User Accounts\n'
      'Account Creation:\n'
      'You must provide accurate and up-to-date information during sign-up, including your email, phone number, and other required details.\n'
      'You are responsible for maintaining the confidentiality of your account credentials.\n'
      'Eligibility:\n'
      'Users must be 21 to create an account.\n'
      'You agree not to create accounts on behalf of others without authorization.\n\n'
      '3. Privacy and Data Usage\n'
      'We respect your privacy. Your data will be collected and processed as outlined in our Privacy Policy.\n'
      'Information provided during sign-up or through the app will be used only for service delivery and communication purposes.\n\n'
      '4. Acceptable Use\n'
      'Prohibited Actions:\n'
      'Sharing your account credentials with others.\n'
      'Misusing the app for illegal, harmful, or unauthorized purposes.\n'
      'Attempting to breach the app\'s security features.\n'
      'Respectful Use:\n'
      'Treat other users respectfully and responsibly.\n'
